...
public class MyBdPushMessageReceiver extends PushMessageReceiver {
    /** TAG to Log */
    private static final String TAG = MyBdPushMessageReceiver.class
            .getSimpleName();
    ...
    public void onNotificationArrived(Context context, String title,
        ...
        intent.putExtra("messageData", description);
